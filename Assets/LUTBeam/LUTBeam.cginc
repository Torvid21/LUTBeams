...
float3 LUTBeamFrag(BeamData beam, bool highQuality = true)
{
    ...
    float framing = 1;
    framing *= SoftBlade(bladePlane0, rayOrigin, rayDir, entryDistance, exitDistance, penumbra);
    framing *= SoftBlade(bladePlane1, rayOrigin, rayDir, entryDistance, exitDistance, penumbra);
    framing *= SoftBlade(bladePlane2, rayOrigin, rayDir, entryDistance, exitDistance, penumbra);
    framing *= SoftBlade(bladePlane3, rayOrigin, rayDir, entryDistance, exitDistance, penumbra);
