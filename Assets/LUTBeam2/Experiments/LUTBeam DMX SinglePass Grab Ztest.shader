...
Shader "MDMX/LUTBeam Experimental SinglePass Grabpass Ztest"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        LOD 100
        Cull Back // Cull back faces and ztest, so it shows up correctly on the player mirror!
        ZTest On
        ZWrite Off
        ...
        Pass
        {
            Name "LUTBeam Experimental SinglePass Grabpass Ztest"
